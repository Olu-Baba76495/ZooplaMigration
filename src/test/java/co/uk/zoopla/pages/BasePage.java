...
public class BasePage extends DriverManager
{
    ...
    //above is declaring a variable and the value is the URL
    //can also be private depending on what i want to do
    // i will then write a method that utilises the above variable see below
